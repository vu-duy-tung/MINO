...
from src.metrics.ocr_free_utils import get_blocks_ocr_free
from src.depup_post_gen import check_repetitive_content
...
def visual_eval_v3_multi(input_list, debug=False):
    ...
    for predict_html in predict_html_list:
        ...
        os.system(f"python src/screenshot_single.py --html {predict_html} --png {predict_img}")
        print(predict_img)
    ...
    os.system(f"python src/screenshot_single.py --html {original_html} --png {original_img}")
